...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Bi,depthTest:!1,depthWrite:!1})}function lp(){return new En({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:sc(),fragmentShader:`
		...
		`,blending:Bi,depthTest:!1,depthWrite:!1})}function cp(){return new En({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:sc(),fragmentShader:`
...
`].filter(Ma).join(`
`)),a=Su(a),a=vp(a,e),a=yp(a,e),o=Su(o),o=vp(o,e),o=yp(o,e),a=Mp(a),o=Mp(o),e.isRawShaderMaterial!==!0&&(M=`#version 300 es
...
void main() {
    ...
    `});xn=new ke(u,_),xn.name="main-planet",xn.position.set(0,0,0),$e.add(xn);const g=new js(f*1.05,48,48),p=new En({uniforms:{glowColor:{value:new kt(14726143)}},vertexShader:`
      varying vec3 vNormal;
      void main() {
        vNormal = normalize(normalMatrix * normal);
        gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
